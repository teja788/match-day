...
export async function generateMetadata({
  ...
  await getScores('cricket');
  const matchId = resolveSlugToId('cricket', slug);
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      type: 'article',
      images: [{ url: `/api/og?sport=cricket&slug=${slug}`, width: 1200, height: 630 }],
    },
    twitter: {
